    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li><a href="<?= BASE_LINK ?>/boutiques/index"><span class=" iconfa-pencil"></span> Gérer les boutiques </a></li>
                <li><a href="<?= BASE_LINK ?>/promos/index"><span class=" iconfa-flag"></span> Gérer les utilisateurs </a></li>
